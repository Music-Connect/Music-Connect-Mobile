    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.profileCard}>
          ...
          {/* Stats Section - Only shows Propostas for contractors */}
          ...
          <View style={styles.quickActions}>
            ...
            <TouchableOpacity
              style={styles.quickActionButton}
              onPress={() => router.push("/(contractor-tabs)/minhas-propostas")}
            >
          ...
          <View style={styles.sectionCard}>
            {user.descricao ? (
              ...
              <Text style={styles.emptyText}>
                Adicione uma descrição para que os artistas possam conhecer seu
                negócio.
              </Text>
            )}
          </View>
        ...
        <View style={styles.section}>
          <View style={styles.menuCard}>
            ...
            <TouchableOpacity
              style={styles.menuItem}
              onPress={() => router.push("/(contractor-tabs)/explore")}
            >
              <Text style={styles.menuIcon}>🎵</Text>
              <Text style={styles.menuText}>Explorar Artistas</Text>
              <Text style={styles.menuArrow}>›</Text>
            </TouchableOpacity>
